    ...
    <section id="contato" className="py-24 bg-surface/30">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          >
            <h3 className="text-text-primary font-semibold">Ou entre em contato diretamente</h3>
                  ...
                  <div className="animated-mail">
                    ...
                    <div className="letter">
                      ...
                      <div className="letter-content">
                        <span className="letter-email">jonathanads2006@gmail.com</span>
                        <div className="letter-btn">Enviar E-mail</div>
                      </div>
                    </div>
            ...
            {/* Social links — same width for both cards */}
            <div className="w-full space-y-3">
              <a
                href="https://linkedin.com/in/jonathan-nascimento-8bb679227"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center gap-4 p-4 glass-card hover:border-accent-blue/30 transition-colors group"
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-text-primary text-sm font-medium truncate">jonathan-nascimento-8bb679227</p>
                </div>
              </a>
